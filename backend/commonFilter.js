...
route.get('/filterReportsWithParticulars/:head',async(req,res)=>{
    ...
    base.query(sql,[req.params.head],(err,rows)=>{
        ...
        for(let i=0;i<rows.length;i++){
            ...
            if(acdyr_id!=null && sem_id==null && major_id==null && sub_id==null && dept_id==null && emp_id==null){
                ...
                let sql=`SELECT * FROM ${rows[i].table_name} where acdyr_id=? and sem_id=? and dept_id=?`
                ...
                let sql=`SELECT * FROM ${rows[i].table_name} where acdyr_id=? and dept_id=? and event_coordinator like ?`
                ...
                let sql=`SELECT * FROM ${rows[i].table_name} where acdyr_id=? and sem_id=? and dept_id=? and event_coordinator like ?`
        ...
        base.query(sql,[major_id],(err,temp)=>{
            ...
            for(let i=0;i<temp.length;i++){
                ...
                if(acdyr_id==null && sem_id==null && major_id!=null && sub_id==null && dept_id==null && emp_id==null){
                    ...
                    let sql=`SELECT * FROM ${temp[i].table_name} where acdyr_id=? and major_report_id=?`
                    ...
                    let sql=`SELECT * FROM ${temp[i].table_name} where major_report_id=? and dept_id=?`
                    ...
                    let sql=`SELECT * FROM ${temp[i].table_name} where acdyr_id=? and sem_id=? and major_report_id=?`
                    ...
                    let sql=`SELECT * FROM ${temp[i].table_name} where major_report_id=? and dept_id=? and event_coordinator like ?`
                    ...
                    let sql=`SELECT * FROM ${temp[i].table_name} where acdyr_id=? and sem_id=? and major_report_id=? and dept_id=? and event_coordinator like ?`
    ...
    if(sub_id!=null){
        if(acdyr_id==null && sem_id==null && major_id!=null && sub_id!=null && dept_id==null && emp_id==null){
            ...
            let sql=`select * from ${sub_id} where dept_id=?`
            base.query(sql,[dept_id],(err,temp)=>{
                if(err){
                    console.log(err)
                    return
            ...
            let sql=`select * from ${sub_id} where acdyr_id=?`
            base.query(sql,[acdyr_id],(err,temp)=>{
                if(err){
                    console.log(err)
                    return
            ...
            let sql=`select * from ${sub_id} where acdyr_id=? and sem_id=?`
            base.query(sql,[acdyr_id,sem_id],(err,temp)=>{
                if(err){
                    console.log(err)
                    return
            ...
            let sql=`select * from ${sub_id} where dept_id=? and event_coordinator like ?`
            base.query(sql,[dept_id,`%${emp_id}%`],(err,temp)=>{
                if(err){
                    console.log(err)
                    return
            ...
            let sql=`select * from ${sub_id} where acdyr_id=? and sem_id=? and dept_id=?`
            base.query(sql,[acdyr_id,sem_id,dept_id],(err,temp)=>{
                if(err){
                    console.log(err)
                    return
            ...
            let sql=`select * from ${sub_id} where acdyr_id=? and dept_id=? and event_coordinator like ?`
            base.query(sql,[acdyr_id,dept_id,`%${emp_id}%`],(err,temp)=>{
                if(err){
                    console.log(err)
                    return
            ...
            let sql=`select * from ${sub_id} where acdyr_id=? and sem_id=? and dept_id=? and event_coordinator like ?`
            base.query(sql,[acdyr_id,sem_id,dept_id,`%${emp_id}%`],(err,temp)=>{
                if(err){
                    console.log(err)
                    return
